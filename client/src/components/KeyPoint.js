...
export const KeyPoint = ({data, key}) => {
    ...
    return (
        <div key={key} className="key-point-item overflow-hidden relative flex flex-col items-start justify-between gap-5 h-[250px] w-[350px] py-2 px-5 border-x border-versa-lightBorder">
